...
Chatea con nosotros: [Discord](https://discord.gg/nDceKgxnkV) | [Twitter](https://twitter.com/schoolwatch) | [Reddit](https://www.reddit.com/r/schoolwatch)

[![ko-fi](https://ko-fi.com/img/githubbutton_sm.svg)](https://ko-fi.com/I2I04VU09)

Otro software de escritorio remoto, escrito en Rust. Funciona de forma inmediata, sin necesidad de configuración. Tienes el control total de tus datos, sin preocupaciones sobre la seguridad. Puedes utilizar nuestro servidor de rendezvous/relay, [instalar el tuyo](https://schoolwatch.com/server), o [escribir tu propio servidor rendezvous/relay](https://github.com/schoolwatch/schoolwatch-server-demo).

SchoolWatch agradece la contribución de todo el mundo. Lee [`docs/CONTRIBUTING.md`](CONTRIBUTING.md) para ayuda para empezar.

[**¿Cómo funciona schoolwatch?**](https://github.com/schoolwatch/schoolwatch/wiki/How-does-SchoolWatch-work%3F)

[**DESCARGA DE BINARIOS**](https://github.com/schoolwatch/schoolwatch/releases)
...
Por favor, asegurate de que estás ejecutando estos comandos desde la raíz del repositorio de SchoolWatch, de lo contrario la aplicación puede ser incapaz de encontrar los recursos necesarios. También ten en cuenta que otros subcomandos de cargo como `install` o `run` no estan actualmente soportados usando este metodo, ya que instalarían o ejecutarían el programa dentro del contenedor en lugar del host.

## Estructura de archivos

- **[libs/hbb_common](https://github.com/schoolwatch/schoolwatch/tree/master/libs/hbb_common)**:  codec de video, configuración, tcp/udp wrapper, protobuf, funciones para transferencia de archivos, y otras funciones de utilidad.
- **[libs/scrap](https://github.com/schoolwatch/schoolwatch/tree/master/libs/scrap)**: captura de pantalla
- **[libs/enigo](https://github.com/schoolwatch/schoolwatch/tree/master/libs/enigo)**: control del teclado/mouse especificos de cada plataforma
- **[src/ui](https://github.com/schoolwatch/schoolwatch/tree/master/src/ui)**: GUI
- **[src/server](https://github.com/schoolwatch/schoolwatch/tree/master/src/server)**: sonido/portapapeles/input/servicios de video, y conexiones de red
- **[src/client.rs](https://github.com/schoolwatch/schoolwatch/tree/master/src/client.rs)**: iniciar una conexión "peer to peer"
- **[src/rendezvous_mediator.rs](https://github.com/schoolwatch/schoolwatch/tree/master/src/rendezvous_mediator.rs)**: Comunicación con [schoolwatch-server](https://github.com/schoolwatch/schoolwatch-server), esperar la conexión remota directa ("TCP hole punching") o conexión indirecta ("relayed")
- **[src/platform](https://github.com/schoolwatch/schoolwatch/tree/master/src/platform)**: código específico de cada plataforma
- **[flutter](https://github.com/schoolwatch/schoolwatch/tree/master/flutter)**: Flutter, código para moviles
- **[flutter/web/js](https://github.com/schoolwatch/schoolwatch/tree/master/flutter/web/js)**: Javascript para el cliente web Flutter

> [!Precaución]
> **Descargo de responsabilidad por uso indebido:** <br>
> Los desarrolladores de SchoolWatch no aprueban ni apoyan ningún uso no ético o ilegal de este software. El uso indebido, como el acceso no autorizado, el control o la invasión de la privacidad, está estrictamente en contra de nuestras directrices. Los autores no son responsables de ningún uso indebido de la aplicación.
