#  SchoolWatch 기여 가이드라인

SchoolWatch는 모든 사람의 기여를 환영합니다. 만약 SchoolWatch에 기여하고 싶다면 아래 가이드를 참고해주세요:

## 기여 방식

SchoolWatch 또는 종속성에 대한 기여는 GitHub Pull Request 형태로 이루어져야 합니다.
...
<br/> PR이나 댓글에서 리뷰어를 태그하거나 [이메일](mailto:info@schoolwatch.com)로 리뷰를 요청할 수 있습니다.
...
SchoolWatch 기여자들은 [Discord](https://discord.gg/nDceKgxnkV)에서 활동하고 있습니다.
