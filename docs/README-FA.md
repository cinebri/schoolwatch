...
<p dir="rtl" align="center"><b>برای ترجمه این سند (README)، <a href="https://github.com/schoolwatch/schoolwatch/tree/master/src/lang" dir="rtl">رابط کاربری SchoolWatch</a>، <a href="https://github.com/schoolwatch/doc.schoolwatch.com" dir="rtl">و مستندات آن</a> به زبان مادری شما به کمکتان نیازمندیم. </b></p>

با ما گفتگو کنید:  [Reddit](https://www.reddit.com/r/schoolwatch) | [Twitter](https://twitter.com/schoolwatch) | [Discord](https://discord.gg/nDceKgxnkV) 


[![ko-fi](https://ko-fi.com/img/githubbutton_sm.svg)](https://ko-fi.com/I2I04VU09)

راست‌دسک (SchoolWatch) نرم‌افزاری برای کارکردن با رایانه‌ی رومیزی از راه دور است و با زبان برنامه‌نویسی Rust نوشته شده است. نیاز به تنظیمات چندانی ندارد و شما را قادر می سازد تا بدون نگرانی از امنیت اطلاعات خود بر آن‌ها کنترل کامل داشته باشید.

می‌توانید از سرور rendezvous/relay ما استفاده کنید، [سرور خودتان را راه‌اندازی کنید](https://schoolwatch.com/server) یا
[ سرورrendezvous/relay  خود را بنویسید](https://github.com/schoolwatch/schoolwatch).

ما از مشارکت همه استقبال می کنیم. برای راهنمایی جهت مشارکت به[`docs/CONTRIBUTING.md`](CONTRIBUTING.md) مراجعه کنید.

[راست‌دسک چطور کار می کند؟](https://github.com/schoolwatch/schoolwatch/wiki/How-does-SchoolWatch-work%3F)

[دریافت نرم‌افزار](https://github.com/schoolwatch/schoolwatch/releases)
...
## [ساخت](https://schoolwatch.com/docs/en/dev/build/)
