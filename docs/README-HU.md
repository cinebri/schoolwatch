<p align="center">
  ...
  <b>Kell a segítséged, hogy lefordítsuk ezt a README-t, <a href="https://github.com/schoolwatch/schoolwatch/tree/master/src/lang">a SchoolWatch UI-t</a> és a <a href="https://github.com/schoolwatch/doc.schoolwatch.com">Dokumentációt</a> az anyanyelvedre</b>
</p>

Beszélgess velünk: [Discord](https://discord.gg/nDceKgxnkV) | [Twitter](https://twitter.com/schoolwatch) | [Reddit](https://www.reddit.com/r/schoolwatch)

[![ko-fi](https://ko-fi.com/img/githubbutton_sm.svg)](https://ko-fi.com/I2I04VU09)

A SchoolWatch egy távoli elérésű asztali szoftver, Rust-ban írva. Működik mindenféle konfiguráció nélkül, feltelepítéssel, vagy anélkül. Az adataidat teljesen te kezeled, nincs szükség aggódásra a harmadik felek miatt. Használhatod a SchoolWatch punblikus randevú/relay szervereit, [hostolhatsz sajátot](https://schoolwatch.com/server), vagy akár [írhatsz is egyet](https://github.com/schoolwatch/schoolwatch-server-demo).

![image](https://user-images.githubusercontent.com/71636191/171661982-430285f0-2e12-4b1d-9957-4a58e375304d.png)

A SchoolWatch szívesen fogad minden contributiont, támogatást mindenkitől. Lásd a [`docs/CONTRIBUTING.md`](CONTRIBUTING.md) fájlt a kezdéshez.

[**Hogyan működik a SchoolWatch?**](https://github.com/schoolwatch/schoolwatch/wiki/How-does-SchoolWatch-work%3F)

[**BINARY LELTÖLTÉS**](https://github.com/schoolwatch/schoolwatch/releases)
...
## [Építés](https://schoolwatch.com/docs/hu/dev/build/)
...
Ezután, minden egyes alkalommal amikor meg kell építened a SchoolWatch-et, futtasd a kövezkező parancsot:
...
Kérlek mindenképpen nézd meg hogy ezeket a parancsokat a root SchoolWatch mappában futtatod e, különben a SchoolWatch lehet hogy nem fogja megtalálni az építéshez szükséges elemeket. Fontos az is, hogy jelenleg más cargo subparancsok, például `install`vagy `run` nem támogatottak, mivel egy Dockeres építés esetén elindítanák a programot a containeren belül.
...
- **[flutter](https://github.com/schoolwatch/schoolwatch/tree/master/flutter)**: Flutter code for mobile
- **[flutter/web/js](https://github.com/schoolwatch/schoolwatch/tree/master/flutter/web/js)**: Javascript for Flutter web client
