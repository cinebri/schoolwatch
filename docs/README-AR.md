<p align="center">
  ...
  <b>  لغتك الأم,  <a href="https://github.com/schoolwatch/doc.schoolwatch.com">Doc</a> و <a href="https://github.com/schoolwatch/schoolwatch/tree/master/src/lang">SchoolWatch UI</a>, README نحن بحاجة إلى مساعدتك لترجمة هذا </b>
</p>

[Discord](https://discord.gg/nDceKgxnkV) | [Twitter](https://twitter.com/schoolwatch) | [Reddit](https://www.reddit.com/r/schoolwatch) :تواصل معنا عبر
...
[جهز لنفسك واحدا](https://schoolwatch.com/server), أو
[خاص بك rendezvous/relay أكتب خادم](https://github.com/schoolwatch/schoolwatch-server-demo).

![image](https://user-images.githubusercontent.com/71636191/171661982-430285f0-2e12-4b1d-9957-4a58e375304d.png)

لمساعدتك على ذلك [`docs/CONTRIBUTING.md`](CONTRIBUTING.md) يرحب بمساهمة الجميع. اطلع على  SchoolWatch.

[**؟ SchoolWatch كيفية يعمل**](https://github.com/schoolwatch/schoolwatch/wiki/How-does-SchoolWatch-work%3F)

[**BINARY تنزيل**](https://github.com/schoolwatch/schoolwatch/releases)
...
## [البناء](https://schoolwatch.com/docs/en/dev/build/)
...
SchoolWatch يرجى التأكد من أنك تنفذ هذه الأوامر من جذر مستودع
...
- **[libs/hbb_common](https://github.com/schoolwatch/schoolwatch/tree/master/libs/hbb_common)**: وظائف  لنقل الملفات، وبعض وظائف المرافق الأخرى tcp/udp، protobuf ترميز الفيديو، إعدادات

- **[libs/scrap](https://github.com/schoolwatch/schoolwatch/tree/master/libs/scrap)**: التقاط الشاشة
- **[libs/enigo](https://github.com/schoolwatch/schoolwatch/tree/master/libs/enigo)**: التحكم في لوحة المفاتيح/الماوس الخاصة بكل منصة
- **[src/ui](https://github.com/schoolwatch/schoolwatch/tree/master/src/ui)**: واجهة المستخدم الرسومية
- **[src/server](https://github.com/schoolwatch/schoolwatch/tree/master/src/server)**: خدمات الصوت/الحافظة/المدخلات/الفيديو، ووصلات الشبكة
- **[src/client.rs](https://github.com/schoolwatch/schoolwatch/tree/master/src/client.rs)**: بدء اتصال متقارن
- **[src/rendezvous_mediator.rs](https://github.com/schoolwatch/schoolwatch/tree/master/src/rendezvous_mediator.rs)**: أو المنقول عن بُعد (TCP hole punching) انتظر الاتصال المباشر [schoolwatch-server](https://github.com/schoolwatch/schoolwatch-server) الإتصال ب
- **[src/platform](https://github.com/schoolwatch/schoolwatch/tree/master/src/platform)**: رمز خاص بكل منصة
- **[flutter](https://github.com/schoolwatch/schoolwatch/tree/master/flutter)**: رمز الهاتف المحمول
- **[flutter/web/js](https://github.com/schoolwatch/schoolwatch/tree/master/flutter/web/js)**:Flutter  لعميل الويب الخاص ب Javascript
