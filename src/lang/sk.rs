...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Pripájam sa na SchoolWatch server..."),
        ...
        ("install_tip", "V niektorých prípadoch SchoolWatch nefunguje správne z dôvodu riadenia užívateľských oprávnení (UAC). Vyhnete sa tomu kliknutím na nižšie zobrazene tlačítko a nainštalovaním RuskDesk do systému."),
        ...
        ("Configure", "Nastaviť"),
        ("config_acc", "Aby bolo možné na diaľku ovládať vašu plochu, je potrebné aplikácii SchoolWatch udeliť práva \"Dostupnosť\"."),
        ("config_screen", "Aby bolo možné na diaľku sledovať vašu obrazovku, je potrebné aplikácii SchoolWatch udeliť práva \"Zachytávanie obsahu obrazovky\"."),
        ...
        ("android_input_permission_tip1", "Aby bolo možné na diaľku ovládať vašu plochu pomocou myši alebo dotykov, je potrebné aplikácii SchoolWatch udeliť práva \"Dostupnosť\"."),
        ("android_input_permission_tip2", "Prejdite na stránku nastavení systému, nájdite a vstúpte do [Stiahnuté služby], zapnite [SchoolWatch Input] službu."),
        ...
        ("Turned off", "Vypnutý"),
        ("Language", "Jazyk"),
        ("Keep SchoolWatch background service", "Ponechať službu SchoolWatch na pozadí"),
        ("Ignore Battery Optimizations", "Ignorovať optimalizácie batérie"),
        ("android_open_battery_optimizations_tip", "Ak chcete túto funkciu vypnúť, prejdite na ďalšiu stránku nastavení SchoolWatchu, vyhľadajte a zadajte položku [Batéria], zrušte začiarknutie položky [Neobmedzené]."),
        ...
        ("Show SchoolWatch", "Zobraziť SchoolWatch"),
        ...
        ("config_input", "Ak chcete ovládať vzdialenú plochu pomocou klávesnice, musíte udeliť oprávnenie SchoolWatch \"Sledovanie vstupu\"."),
        ("config_microphone", "Ak chcete hovoriť na diaľku, musíte SchoolWatchu udeliť povolenie \"Nahrávať zvuk\"."),
        ...
        ("still_click_uac_tip", "Stále sa vyžaduje, aby vzdialený používateľ klikol na tlačidlo OK v okne UAC spusteného programu SchoolWatch."),
        ...
        ("verify_SchoolWatch_password_tip", "Overenie hesla SchoolWatch"),
        ...
        ("scam_text1", "Ak telefonujete s niekým, koho nepoznáte a komu nedôverujete a kto vás požiadal o použitie a spustenie aplikácie SchoolWatch, nepokračujte v hovore a okamžite zaveste."),
        ...
        ("upgrade_SchoolWatch_server_pro_to_{}_tip", "Aktualizujte SchoolWatch Server Pro na verziu {} alebo novšiu!"),
        ...
        ("selinux_tip", "Na vašom zariadení je povolený SELinux, čo môže brániť správnemu spusteniu SchoolWatchu ako spravovanej strany."),
        ...
        ("powered_by_me", "Poháňané aplikáciou SchoolWatch"),
        ...
        ("allow-only-conn-window-open-tip", "Povoliť pripojenie iba vtedy, ak je otvorené okno aplikácie SchoolWatch"),
        ...
        ("floating_window_tip", "Pomáha udržiavať službu SchoolWatch na pozadí"),
        ...
        ("upgrade_remote_SchoolWatch_client_to_{}_tip", "Aktualizujte klienta SchoolWatch na verziu {} alebo novšiu na vzdialenej strane!"),
