...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("install_tip", "Előfordul, hogy bizonyos esetekben hiba léphet fel a Portable verzió használatakor. A megfelelő működés érdekében, telepítse a SchoolWatch alkalmazást a számítógépére."),
        ...
        ("Configure", "Beállítás"),
        ("config_acc", "A távoli vezérléshez a SchoolWatchnek „Kisegítő lehetőségek” engedélyre van szüksége"),
        ...
        ("android_input_permission_tip2", "A következő rendszerbeállítások oldalon a letöltött alkalmazások menüponton belül, kapcsolja be a [SchoolWatch Input] szolgáltatást."),
        ...
        ("Language", "Nyelv"),
        ("Keep SchoolWatch background service", "SchoolWatch futtatása a háttérben"),
        ("Ignore Battery Optimizations", "Akkumulátorkímélő figyelmen kívül hagyása"),
        ("android_open_battery_optimizations_tip", "Ha le szeretné tiltani ezt a funkciót, lépjen a SchoolWatch alkalmazás beállításaiba, keresse meg az [Akkumulátorkímélő] lehetőséget és válassza a nincs korlátozás lehetőséget."),
        ...
        ("Show SchoolWatch", "A SchoolWatch megjelenítése"),
        ...
        ("config_input", "Ahhoz, hogy a távoli asztalt a billentyűzettel vezérelhesse, a SchoolWatchnek meg kell adnia a „Bemenet figyelése” jogosultságot."),
        ("config_microphone", "Ahhoz, hogy távolról beszélhessen, meg kell adnia a SchoolWatchnek a „Hangfelvétel” jogosultságot."),
        ...
        ("still_click_uac_tip", "A távoli felhasználónak továbbra is az „Igen” gombra kell kattintania a SchoolWatch UAC ablakában. Kattintson!"),
        ...
        ("verify_SchoolWatch_password_tip", "SchoolWatch jelszó megerősítése"),
        ...
        ("scam_text1", "Ha olyan valakivel beszél telefonon, akit NEM ISMER, akiben NEM BÍZIK MEG, és aki arra kéri, hogy használja a SchoolWatchet és indítsa el a szolgáltatást, ne folytassa, és azonnal tegye le a telefont."),
        ...
        ("upgrade_SchoolWatch_server_pro_to_{}_tip", "Frissítse a SchoolWatch Server Prot a(z) {} vagy újabb verzióra!"),
        ...
        ("selinux_tip", "A SELinux engedélyezve van az eszközén, ami azt okozhatja, hogy a SchoolWatch nem fut megfelelően, mint ellenőrzött webhely."),
        ...
        ("powered_by_me", "Üzemeltető: SchoolWatch"),
        ("outgoing_only_desk_tip", "Ez a SchoolWatch testre szabott kimenete.\nMás eszközökhöz kapcsolódhat, de más eszközök nem kapcsolódhatnak az Ön eszközéhez."),
        ("preset_password_warning", "Ez egy testre szabott kimenet a SchoolWatchből egy előre beállított jelszóval. Bárki, aki ismeri ezt a jelszót, teljes irányítást szerezhet a készülék felett. Ha nem kívánja ezt megtenni, azonnal távolítsa el ezt a szoftvert."),
        ...
        ("allow-only-conn-window-open-tip", "Csak akkor engedélyezze a kapcsolódást, ha a SchoolWatch ablak nyitva van."),
        ...
        ("floating_window_tip", "Segít, ha a SchoolWatch a háttérben fut."),
        ...
        ("About SchoolWatch", "SchoolWatch névjegye"),
        ...
        ("upgrade_remote_SchoolWatch_client_to_{}_tip", "Frissítse a SchoolWatch klienst {} vagy újabb verziójára a távoli oldalon!"),
