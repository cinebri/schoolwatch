...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Ready", "מוכן"),
        ("Established", ""),
        ("connecting_status", "מתחבר לרשת SchoolWatch..."),
        ("Enable service", ""),
        ...
        ("install_tip", "בגלל UAC, SchoolWatch לא יכול לפעול כראוי כצד מרוחק בחלק מהמקרים. כדי להימנע מ-UAC, אנא לחץ על הכפתור למטה כדי להתקין את SchoolWatch במערכת."),
        ("Click to upgrade", ""),
        ("Click to download", ""),
        ("Click to update", ""),
        ("Configure", ""),
        ("config_acc", "כדי לשלוט מרחוק בשולחן העבודה שלך, עליך להעניק ל-SchoolWatch הרשאות \"נגישות\"."),
        ("config_screen", "כדי לגשת מרחוק לשולחן העבודה שלך, עליך להעניק ל-SchoolWatch הרשאות \"הקלטת מסך\"."),
        ("Installing ...", ""),
        ("Install", "התקן"),
        ("Installation", ""),
        ...
        ("android_input_permission_tip1", "כדי שמכשיר מרוחק יוכל לשלוט במכשיר האנדרואיד שלך באמצעות עכבר או מגע, עליך לאפשר ל-SchoolWatch להשתמש בשירות \"נגישות\"."),
        ("android_input_permission_tip2", "אנא עבור לדף ההגדרות של המערכת הבא, מצא והכנס ל[שירותים מותקנים], הפעל את שירות [SchoolWatch Input]."),
        ...
        ("Turned off", ""),
        ("Language", "שפה"),
        ("Keep SchoolWatch background service", ""),
        ("Ignore Battery Optimizations", "התעלם מאופטימיזציות סוללה"),
        ("android_open_battery_optimizations_tip", "אם ברצונך לבטל תכונה זו, אנא עבור לדף ההגדרות של יישום SchoolWatch הבא, מצא והכנס ל[סוללה], הסר את הסימון מ-[לא מוגבל]"),
        ("Start on boot", ""),
        ...
        ("config_input", "כדי לשלוט בשולחן העבודה המרוחק באמצעות מקלדת, עליך להעניק ל-SchoolWatch הרשאות \"מעקב אחרי קלט\"."),
        ("config_microphone", "כדי לדבר מרחוק, עליך להעניק ל-SchoolWatch הרשאות \"הקלטת שמע\"."),
        ...
        ("still_click_uac_tip", "עדיין דורש מהמשתמש המרוחק ללחוץ OK בחלון ה-UAC של הרצת SchoolWatch."),
        ...
        ("verify_SchoolWatch_password_tip", "אמת סיסמת SchoolWatch"),
        ...
        ("scam_text1", "אם אתה בשיחת טלפון עם מישהו שאינך מכיר ואינך סומך עליו שביקש ממך להשתמש ב-SchoolWatch ולהתחיל את השירות, אל תמשיך ונתק מיד."),
        ...
        ("upgrade_SchoolWatch_server_pro_to_{}_tip", "אנא שדרג את SchoolWatch Server Pro לגרסה {} או חדשה יותר!"),
        ...
        ("selinux_tip", "SELinux מופעל במכשיר שלך, מה שעלול למנוע מ-SchoolWatch לפעול כראוי כצד הנשלט."),
        ...
        ("About SchoolWatch", "אודות SchoolWatch"),
        ...
        ("Accessible devices", ""),
        ("View camera", ""),
        ("upgrade_remote_SchoolWatch_client_to_{}_tip", "אנא שדרג את לקוח SchoolWatch לגרסה {} או חדשה יותר בצד המרוחק!"),
