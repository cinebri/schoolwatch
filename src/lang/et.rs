...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "SchoolWatchi võrguga ühendumine..."),
        ...
        ("install_tip", "Kasutajakonto kontrolli (UAC) tõttu ei saa SchoolWatch mõnel juhul korralikult kaugjuhtimispoolena töötada. Kontrolli vältimiseks palun klõpsa alloleval nupul, et SchoolWatch oma süsteemi paigaldada."),
        ("Click to upgrade", "Vajuta täiendamiseks"),
        ("Click to download", "Vajuta allalaadimiseks"),
        ("Click to update", "Vajuta uuendamiseks"),
        ("Configure", "Seadista"),
        ("config_acc", "Töölaua kaugjuhtimiseks tuleb SchoolWatchile anda \"juurdepääsetavuse\" õigused."),
        ("config_screen", "Töölaua kaugjuhtimiseks tuleb SchoolWatchile anda \"ekraanisalvestuse\" õigused."),
        ...
        ("android_input_permission_tip1", "Selleks, et kaugseade saaks sinu Androidi seadet juhtida hiire või puute abil, pead andma SchoolWatchile \"juurdepääsetavuse\" loa."),
        ("android_input_permission_tip2", "Palun mine järgmisele süsteemiseadete lehele, leia ja sisesta [Paigaldatud teenused], lülita teenus [SchoolWatch Input] sisse."),
        ...
        ("Language", "Keel"),
        ("Keep SchoolWatch background service", "Säilita SchoolWatchi taustateenus"),
        ("Ignore Battery Optimizations", "Ignoreeri akuoptimeerimisi"),
        ("android_open_battery_optimizations_tip", "Kui soovid selle funktsiooni keelata, palun mine järgmisele SchoolWatchi rakenduse seadete lehele, leia ja sisesta [Aku], eemalda linnuke valikult [Piiramata]"),
        ...
        ("Show SchoolWatch", "Kuva SchoolWatch"),
        ("This PC", "See arvuti"),
        ("or", "või"),
        ...
        ("config_input", "Kaugtöölaua klaviatuuriga juhtimiseks pead andma SchoolWatchile \"sisendi jälgimise\" õigused."),
        ("config_microphone", "Kaugelt rääkimiseks pead andma SchoolWatchile \"heli salvestamise\" õigused."),
        ...
        ("still_click_uac_tip", "Kaugkasutaja peab siiski ise vajutama käitatud SchoolWatchi kasutajakonto kontrollis (UAC) OK-nuppu."),
        ...
        ("verify_SchoolWatch_password_tip", "Kinnita SchoolWatchi parool"),
        ...
        ("scam_text1", "Kui räägid telefoniga kellegagi, keda EI TUNNE ja EI USALDA, kes on palunud sul SchoolWatchi kasutada ja teenus käivitada, ära jätka ning lõpeta kõne koheselt."),
        ...
        ("upgrade_SchoolWatch_server_pro_to_{}_tip", "Palun täienda SchoolWatch Server Pro versioonile {} või uuem!"),
        ...
        ("selinux_tip", "SELinux on su seadmes lubatud, mis võib SchoolWatchil takistada juhitud poolel toimimist."),
        ...
        ("powered_by_me", "Põhineb SchoolWatchil"),
        ...
        ("allow-only-conn-window-open-tip", "Luba ühendus ainult siis, kui SchoolWatchi aken on avatud."),
        ...
        ("floating_window_tip", "See aitab säilitada SchoolWatchi taustateenust."),
        ...
        ("About SchoolWatch", "SchoolWatchi teave"),
        ...
        ("upgrade_remote_SchoolWatch_client_to_{}_tip", "Täiendage SchoolWatchi klient kaugküljel versioonile {} või uuemale!"),
