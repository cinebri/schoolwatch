...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Σύνδεση στο δίκτυο SchoolWatch..."),
        ...
        ("install_tip", "Λόγω UAC, το SchoolWatch ενδέχεται να μην λειτουργεί σωστά σε ορισμένες περιπτώσεις. Για να αποφύγετε το UAC, κάντε κλικ στο κουμπί παρακάτω για να εγκαταστήσετε το SchoolWatch στο σύστημα"),
        ("Click to upgrade", "Αναβάθμιση τώρα"),
        ("Click to download", "Λήψη τώρα"),
        ("Click to update", "Ενημέρωση τώρα"),
        ("Configure", "Διαμόρφωση"),
        ("config_acc", "Για τον απομακρυσμένο έλεγχο του υπολογιστή σας, πρέπει να εκχωρήσετε δικαιώματα πρόσβασης στο SchoolWatch."),
        ("config_screen", "Για να αποκτήσετε απομακρυσμένη πρόσβαση στον υπολογιστή σας, πρέπει να εκχωρήσετε το δικαίωμα SchoolWatch \"Screen Capture\"."),
        ...
        ("android_input_permission_tip1", "Για να μπορεί μία απομακρυσμένη συσκευή να ελέγχει τη συσκευή σας Android, πρέπει να επιτρέψετε στο SchoolWatch να χρησιμοποιεί την υπηρεσία \"Προσβασιμότητα\"."),
        ("android_input_permission_tip2", "Παρακαλώ μεταβείτε στην επόμενη σελίδα ρυθμίσεων συστήματος, βρείτε και πληκτρολογήστε [Εγκατεστημένες υπηρεσίες], ενεργοποιήστε την υπηρεσία [Είσοδος SchoolWatch]."),
        ...
        ("Language", "Γλώσσα"),
        ("Keep SchoolWatch background service", "Εκτέλεση του SchoolWatch στο παρασκήνιο"),
        ...
        ("Show SchoolWatch", "Εμφάνιση SchoolWatch"),
        ...
        ("config_input", "Για να ελέγξετε την απομακρυσμένη επιφάνεια εργασίας με πληκτρολόγιο, πρέπει να εκχωρήσετε δικαιώματα στο SchoolWatch"),
        ...
        ("still_click_uac_tip", "Εξακολουθεί να απαιτεί από τον απομακρυσμένο χρήστη να κάνει κλικ στο OK στο παράθυρο UAC όπου εκτελείται το SchoolWatch."),
        ...
        ("verify_SchoolWatch_password_tip", "Επιβεβαιώστε τον κωδικό του SchoolWatch"),
        ...
        ("scam_text1", "Αν σας καλέσει κάποιος τον οποίο ΔΕΝ γνωρίζεται και ΔΕΝ ΕΜΠΙΣΤΕΥΕΣΤΕ, και σας ζητήσει να ανοίξετε το SchoolWatch, και να του πείτε τα στοιχεία που εμφανίζει, ΜΗΝ συνεχίσετε και κλείστε το τηλέφωνο ΑΜΕΣΩΣ."),
        ...
        ("upgrade_SchoolWatch_server_pro_to_{}_tip", "Παρακαλώ ενημερώστε τον SchoolWatch Server Pro στην έκδοση {} ή νεότερη!"),
        ...
        ("selinux_tip", "Έχετε ενεργοποιημένο το SELinux, το οποίο πιθανόν εμποδίζει την ορθή λειτουργία του SchoolWatch."),
        ...
        ("powered_by_me", "Με την υποστήριξη της SchoolWatch"),
        ...
        ("allow-only-conn-window-open-tip", "Να επιτρέπεται η σύνδεση μόνο εάν το παράθυρο SchoolWatch είναι ανοιχτό"),
        ...
        ("During service is on", "Κατα την εκκίνηση της υπηρεσίας SchoolWatch"),
        ...
        ("About SchoolWatch", "Πληροφορίες για το SchoolWatch"),
        ...
        ("upgrade_remote_SchoolWatch_client_to_{}_tip", "Αναβαθμίστε τον πελάτη SchoolWatch στην έκδοση {} ή νεότερη στην απομακρυσμένη πλευρά!"),
