...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "جاري الاتصال بشبكة SchoolWatch..."),
        ...
        ("install_tip", "بسبب صلاحيات تحكم حساب المستخدم. SchoolWatch قد لا يعمل بشكل صحيح في جهة البعيد في بعض الحالات. لتفادي ذلك. الرجاء الضغط على الزر ادناه لتثبيت SchoolWatch في جهازك."),
        ("Click to upgrade", "اضغط للارتقاء"),
        ("Click to download", "اضغط للتنزيل"),
        ("Click to update", "ضغط للتحديث"),
        ("Configure", "تهيئة"),
        ("config_acc", "لتتمكن من التحكم بسطح مكتبك البعيد, تحتاج الى منح SchoolWatch اذونات \"امكانية الوصول\"."),
        ("config_screen", "لتتمكن من الوصول الى سطح مكتبك البعيد, تحتاج الى منح SchoolWatch اذونات \"تسجيل الشاشة\"."),
        ...
        ("android_input_permission_tip1", "لكي يتمكن جهاز بعيد من التحكم بجهازك الـ Android عن طريق الفارة أو اللمس، يلزمك السماح لـ SchoolWatch باستخدام خدمة \"إمكانية الوصول\"."),
        ("android_input_permission_tip2", "يرجى الانتقال إلى صفحة إعدادات النظام التالية، والعثور على [الخدمات المثبتة]، وتشغيل خدمة [SchoolWatch Input]."),
        ...
        ("Turned off", "مطفئ"),
        ("Language", "اللغة"),
        ("Keep SchoolWatch background service", "ابق خدمة SchoolWatch تعمل في الخلفية"),
        ("Ignore Battery Optimizations", "تجاهل تحسينات البطارية"),
        ("android_open_battery_optimizations_tip", "اذا اردت تعطيل هذه الميزة, الرجاء الذهاب الى صفحة اعدادات تطبيق SchoolWatch, ابحث عن البطارية, الغ تحديد غير مقيد"),
        ...
        ("Show SchoolWatch", "عرض SchoolWatch"),
        ("This PC", "هذا الحاسب"),
        ("or", "او"),
        ...
        ("config_input", "لتتمكن من التحكم بسطح المكتب البعيد. يجب من SchoolWatch اذونات \"مراقبة المدخلات\"."),
        ("config_microphone", "لتتمكن من التحدث. يجب منح SchoolWatch اذونات \"تسجيل الصوت\"."),
        ...
        ("still_click_uac_tip", "لازال يحتاج المستخدم البعيد للضغط على موافق في نافذة تحكم حساب المستخدم في SchoolWatch الذي يعمل."),
        ...
        ("verify_SchoolWatch_password_tip", "تحقق من كلمة مرور SchoolWatch"),
        ...
        ("upgrade_SchoolWatch_server_pro_to_{}_tip", "ترقية خادم SchoolWatch Pro إلى {}"),
        ...
        ("enable-bot-tip", "تمكين البوت للتفاعل مع SchoolWatch"),
        ...
        ("About SchoolWatch", "حول SchoolWatch"),
        ...
        ("upgrade_remote_SchoolWatch_client_to_{}_tip", "ترقية عميل SchoolWatch البعيد إلى {}"),
