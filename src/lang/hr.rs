...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Spajanje na SchoolWatch mrežu..."),
        ...
        ("install_tip", "Zbog UAC-a SchoolWatch ne može u nekim slučajevima raditi pravilno. Da biste prevazišli UAC, kliknite na tipku ispod da instalirate SchoolWatch na sustav."),
        ...
        ("config_acc", "Da biste daljinski kontrolirali radnu površinu, SchoolWatch-u trebate dodijeliti prava za \"Pristupačnost\"."),
        ("config_screen", "Da biste daljinski pristupili radnoj površini, SchoolWatch-u trebate dodijeliti prava za \"Snimanje zaslona\"."),
        ...
        ("android_input_permission_tip1", "Da bi ste daljinski uređaj kontrolirali vašim Android uređajem preko miša ili na dodir, trebate dopustiti SchoolWatch-u da koristi servis \"Pristupačnost\"."),
        ("android_input_permission_tip2", "Molimo prijeđite na sljedeću stranicu podešavanja sustava, pronađite i unesite [Instalirani servisi], uključite servis [SchoolWatch Input]."),
        ...
        ("Language", "Jezik"),
        ("Keep SchoolWatch background service", "Zadrži SchoolWatch kao pozadinski servis"),
        ("Ignore Battery Optimizations", "Zanemari optimizaciju baterije"),
        ("android_open_battery_optimizations_tip", "Ako želite onemogućiti ovu funkciju, molimo idite na sljedeću stranicu za podešavanje SchoolWatch aplikacije, pronađite i uđite u [Baterija], onemogućite [Neograničeno]"),
        ...
        ("Show SchoolWatch", "Prikaži SchoolWatch"),
        ...
        ("config_input", "Za upravljanje udaljenom radnom površinom pomoću tipkovnice, morate dodijeliti SchoolWatchu dopuštenje \"Nadzor unosa\"."),
        ("config_microphone", "Da biste razgovarali na daljinu, morate dopustiti SchoolWatchu \"Snimanje zvuka\"."),
        ...
        ("still_click_uac_tip", "Još uvijek zahtijeva da udaljeni korisnik klikne OK u UAC prozoru pokrenutog SchoolWatcha."),
        ...
        ("verify_SchoolWatch_password_tip", "Provjera lozinke za SchoolWatch"),
        ...
        ("scam_text1", "Ako razgovarate telefonom s nekim koga NE POZNAJETE i NE VJERUJETE tko vas je zamolio da koristite i pokrenete SchoolWatch, nemojte nastavljati razgovor i odmah spustite slušalicu."),
        ...
        ("upgrade_SchoolWatch_server_pro_to_{}_tip", "Ažurirajte SchoolWatch Server Pro na verziju {} ili noviju!"),
        ...
        ("selinux_tip", "Na vašem uređaju je omogućen SELinux, što može spriječiti SchoolWatch da pravilno radi kao upravljana strana."),
        ...
        ("powered_by_me", "Pokreće SchoolWatch"),
        ...
        ("upgrade_remote_SchoolWatch_client_to_{}_tip", "Molimo ažurirajte SchoolWatch klijent na verziju {} ili noviju na udaljenoj strani!"),
