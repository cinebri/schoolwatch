...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("install_tip", "SchoolWatch może nie działać poprawnie na maszynie zdalnej z przyczyn związanych z UAC. W celu uniknięcia problemów z UAC, kliknij poniższy przycisk by zainstalować SchoolWatch w swoim systemie."),
        ...
        ("Discovered", "Wykryte"),
        ("install_daemon_tip", "By uruchomić SchoolWatch przy starcie systemu, musisz zainstalować usługę systemową."),
        ("Remote ID", "Zdalne ID"),
        ("Paste", "Wklej"),
        ...
        ("android_input_permission_tip1", "Aby można było sterować Twoim urządzeniem za pomocą myszy lub dotyku, musisz zezwolić SchoolWatch na korzystanie z usługi \"Ułatwienia dostępu\"."),
        ("android_input_permission_tip2", "Przejdź do następnej strony ustawień systemowych, znajdź i wejdź w [Zainstalowane usługi], włącz usługę [SchoolWatch Input]."),
        ...
        ("Language", "Język"),
        ("Keep SchoolWatch background service", "Zachowaj usługę SchoolWatch w tle"),
        ("Ignore Battery Optimizations", "Ignoruj optymalizację baterii"),
        ("android_open_battery_optimizations_tip", "Jeśli chcesz wyłączyć tę funkcję, przejdź do następnej strony ustawień aplikacji SchoolWatch, znajdź i wprowadź [Bateria], odznacz [Bez ograniczeń]"),
        ...
        ("Show SchoolWatch", "Pokaż SchoolWatch"),
        ...
        ("config_input", "By kontrolować zdalne urządzenie przy pomocy klawiatury, musisz udzielić aplikacji SchoolWatch uprawnień do \"Urządzeń Wejściowych\"."),
        ...
        ("empty_lan_tip", "Ojej, wygląda na to, że nie odkryliśmy żadnych urządzeń z SchoolWatch w Twojej sieci."),
        ...
        ("verify_SchoolWatch_password_tip", "Weryfikuj hasło SchoolWatch"),
        ...
        ("scam_text1", "Jeżeli rozmawiasz przez telefon z osobą której NIE ZNASZ i NIE UFASZ, która prosi Cię o uruchomienie programu SchoolWatch - nie rób tego i natychmiast się rozłącz."),
        ...
        ("upgrade_SchoolWatch_server_pro_to_{}_tip", "Proszę zaktualizować SchoolWatch Server Pro do wersji {} lub nowszej!"),
        ...
        ("selinux_tip", "SELinux jest włączony na Twoim urządzeniu, co może przeszkodzić w uruchomieniu SchoolWatch po stronie kontrolowanej."),
        ...
        ("powered_by_me", "Obsługiwane przez SchoolWatch"),
        ...
        ("allow-only-conn-window-open-tip", "Zezwalaj na połączenie tylko wtedy, gdy okno SchoolWatch jest otwarte"),
        ...
        ("floating_window_tip", "Pozwala zachować usługę SchoolWatch w tle"),
        ...
        ("upgrade_remote_SchoolWatch_client_to_{}_tip", "Proszę zaktualizować zdalny klient SchoolWatch do wersji {} lub nowszej!"),
