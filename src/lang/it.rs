...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Connessione alla rete SchoolWatch..."),
        ...
        ("install_tip", "A causa del Controllo Account Utente (UAC), SchoolWatch potrebbe non funzionare correttamente come desktop remoto.\nPer evitare questo problema, fai clic sul tasto qui sotto per installare SchoolWatch a livello di sistema."),
        ("Click to upgrade", "Aggiorna"),
        ("Click to download", "Download"),
        ("Click to update", "Aggiorna"),
        ("Configure", "Configura"),
        ("config_acc", "Per controllare il desktop dall'esterno, devi fornire a SchoolWatch il permesso 'Accessibilità'."),
        ("config_screen", "Per controllare il desktop dall'esterno, devi fornire a SchoolWatch il permesso 'Registrazione schermo'."),
        ...
        ("android_input_permission_tip1", "Affinché un dispositivo remoto possa controllare un dispositivo Android tramite mouse o tocco, devi consentire a SchoolWatch di usare il servizio 'Accessibilità'."),
        ("android_input_permission_tip2", "Vai nella pagina delle impostazioni di sistema che si aprirà di seguito, trova e accedi a [Servizi installati], attiva il servizio [SchoolWatch Input]."),
        ...
        ("Turned off", "Spegni"),
        ("Language", "Lingua"),
        ("Keep SchoolWatch background service", "Mantieni il servizio di SchoolWatch in background"),
        ("Ignore Battery Optimizations", "Ignora le ottimizzazioni della batteria"),
        ("android_open_battery_optimizations_tip", "Se vuoi disabilitare questa funzione, vai nelle impostazioni dell'applicazione SchoolWatch, apri la sezione 'Batteria' e deseleziona 'Senza restrizioni'."),
        ...
        ("Show SchoolWatch", "Visualizza SchoolWatch"),
        ("This PC", "Questo PC"),
        ("or", "O"),
        ...
        ("config_input", "Per controllare il desktop remoto con la tastiera, è necessario concedere le autorizzazioni a SchoolWatch 'Monitoraggio input'."),
        ("config_microphone", "Per poter chiamare, è necessario concedere l'autorizzazione 'Registra audio' a SchoolWatch."),
        ...
        ("still_click_uac_tip", "Richiedi ancora che l'utente remoto selezioni 'OK' nella finestra UAC dell'esecuzione di SchoolWatch."),
        ...
        ("verify_SchoolWatch_password_tip", "Conferma password SchoolWatch"),
        ...
        ("Exit", "Esci da SchoolWatch"),
        ("Open", "Apri SchoolWatch"),
        ...
        ("scam_text1", "Se sei al telefono con qualcuno che NON conosci NON DI TUA FIDUCIA che ti ha chiesto di usare SchoolWatch e di avviare il servizio, non procedere e riattacca subito."),
        ...
        ("upgrade_SchoolWatch_server_pro_to_{}_tip", "Aggiorna SchoolWatch Server Pro alla versione {} o successiva!"),
        ...
        ("selinux_tip", "In questo dispositivo è abilitato SELinux, che potrebbe impedire il corretto funzionamento di SchoolWatch come lato controllato."),
        ...
        ("powered_by_me", "Alimentato da SchoolWatch"),
        ...
        ("allow-only-conn-window-open-tip", "Consenti connessione solo se la finestra SchoolWatch è aperta"),
        ...
        ("floating_window_tip", "Aiuta a mantenere il servizio SchoolWatch in background."),
        ...
        ("About SchoolWatch", "Info su SchoolWatch"),
        ...
        ("upgrade_remote_SchoolWatch_client_to_{}_tip", "Aggiorna il client SchoolWatch remoto alla versione {} o successiva!"),
