...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "S'està connectant a la xarxa de SchoolWatch..."),
        ...
        ("install_tip", "En alguns casos és possible que el SchoolWatch no funcioni correctament per les restriccions UAC («User Account Control»; Control de comptes d'usuari). Per evitar aquest problema, instal·leu el SchoolWatch al vostre sistema."),
        ...
        ("Configure", "Configura"),
        ("config_acc", "Per a poder controlar el dispositiu remotament, faciliteu al SchoolWatch els permisos d'accessibilitat."),
        ("config_screen", "Per a poder controlar el dispositiu remotament, faciliteu al SchoolWatch els permisos de gravació de pantalla."),
        ...
        ("android_input_permission_tip1", "Per a controlar de forma remota el vostre dispositiu amb gestos o un ratolí, heu de permetre al SchoolWatch l'ús del servei «Accessibilitat»."),
        ("android_input_permission_tip2", "A l'apartat Configuració del sistema de la pàgina següent, aneu a «Serveis baixats», i activeu el «SchoolWatch Input»."),
        ...
        ("Language", "Idioma"),
        ("Keep SchoolWatch background service", "Manté el servei del SchoolWatch en rerefons"),
        ("Ignore Battery Optimizations", "Ignora les optimitzacions de bateria"),
        ("android_open_battery_optimizations_tip", "Si voleu desactivar aquesta característica, feu-ho des de la pàgina següent de configuració del SchoolWatch, utilitzant l'opció relativa a «Bateria»"),
        ...
        ("Show SchoolWatch", "Mostra el SchoolWatch"),
        ...
        ("config_input", "Per a poder controlar el dispositiu remotament amb el teclat, faciliteu al SchoolWatch els permisos d'entrada necessaris."),
        ("config_microphone", "Per a poder parlar remotament, faciliteu al SchoolWatch els permisos de gravació d'àudio necessaris."),
        ...
        ("still_click_uac_tip", "Es requereix acceptació manual a la part remota de la finestra «UAC» del SchoolWatch en execució."),
        ...
        ("verify_SchoolWatch_password_tip", "Verifica la contrasenya del SchoolWatch"),
        ...
        ("scam_text1", "Si cap persona qui NO coneixeu NI CONFIEU us demanés l'ús del SchoolWatch, no continueu i talleu la comunicació immediatament."),
        ...
        ("upgrade_SchoolWatch_server_pro_to_{}_tip", "Actualitzeu el SchoolWatch Server Pro a la versió {} o superior!"),
        ...
        ("selinux_tip", "SELinux està activat al vostre dispositiu, la qual cosa evita que el SchoolWatch funcioni correctament com a equip controlable."),
        ...
        ("powered_by_me", "Amb la tecnologia de SchoolWatch"),
        ...
        ("allow-only-conn-window-open-tip", "Permet la connexió només si la finestra del SchoolWatch està activa"),
        ...
        ("floating_window_tip", "Ajuda a mantenir el servei del SchoolWatch en rerefons"),
        ...
        ("About SchoolWatch", "Quant al SchoolWatch"),
        ...
        ("upgrade_remote_SchoolWatch_client_to_{}_tip", "Veuillez mettre à niveau le client SchoolWatch vers la version {} ou plus récente du côté distant !"),
