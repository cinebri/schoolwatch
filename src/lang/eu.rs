...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "SchoolWatch sarera konektatzen..."),
        ...
        ("install_tip", "Erabiltzaile Kontuen Kontrolarengatik, SchoolWatch ezin du ondo funtzionatu urruneko mahaigainean. EKK saihesteko, mesedez, egin klik azpiko botoian SchoolWatch sistema mailan instalatzeko."),
        ...
        ("config_acc", "Zure mahaigaina urrunetik kontrolatzeko, SchoolWatch-i \"Irisgarritasuna\" baimenak eman behar dituzu."),
        ("config_screen", "Zure mahaigaina kanpotik kontrolatzeko, SchoolWatch-i \"Pantaila grabatu\" baimena eman behar duzu."),
        ...
        ("android_input_permission_tip1", "Urruneko gailu batek zure Android gailua saguaren edo ukipenaren bidez kontrolatzeko, SchoolWatch \"Irisgarritasuna\" zerbitzua erabiltzeko baimena eman behar diozu."),
        ("android_input_permission_tip2", "Joan hurrengo irekiko den sistemaren konfigurazio orrira, bilatu eta sartu [Instalatutako zerbitzuak], aktibatu [SchoolWatch Input] zerbitzua."),
        ...
        ("Turned off", "Itzalita"),
        ("Language", "Hizkuntza"),
        ("Keep SchoolWatch background service", "Mantendu SchoolWatch atzeko planoko zerbitzu bezala"),
        ("Ignore Battery Optimizations", "Ezikusi bateria optimizazioak"),
        ("android_open_battery_optimizations_tip", "Ezaugarri hau desgaitu nahi baduzu, joan zaitez SchoolWatch aplikazioaren ezarpen orrira, bilatu eta saltu [Bateria] orrira eta kendu [Mugarik gabe]"),
        ...
        ("Show SchoolWatch", "Erakutsi SchoolWatch"),
        ("This PC", "PC hau"),
        ("or", "edo"),
        ...
        ("config_input", "Urruneko mahaigaina teklatuaren bidez kontrolatzeko, SchoolWatch-i \"Sarrera monitorizazioa\" baimena eman behar diozu."),
        ("config_microphone", "Urrunetik hitz egin ahal izateko, SchoolWatchi-i \"Grabatu audioa\" baimena eman behar diozu."),
        ...
        ("still_click_uac_tip", "Oraindik beharrezkoa da urruneko erabiltzaileak Ondo botoiari klik egitea exekutatzen ari den SchoolWatch UAC leihoan"),
        ...
        ("verify_SchoolWatch_password_tip", "Berretsi SchoolWatch pasahitza"),
        ...
        ("scam_text1", "Ezagutzen eta fidatzen EZ duzun norbaitekin telefonoz bazaude eta SchoolWatch erabiltzeko eta zerbitzua abiarazteko eskatu badizute, ez ezazu egin eta eskegi berehala."),
        ...
        ("upgrade_SchoolWatch_server_pro_to_{}_tip", "Mesedez, bertsio-berritu SchoolWatch Server Pro {} bertsiora edo berriago batera!"),
        ...
        ("selinux_tip", "SELinux zure gailuan gaituta dago. Honek SchoolWatch kontrolatutako alde gisa dagoenean behar bezala ez exekutatzea ekarri dezake."),
        ...
        ("powered_by_me", "SchoolWatch-ek egina"),
        ...
        ("allow-only-conn-window-open-tip", "Baimendu konexioa SchoolWatch leihoa irekita badago"),
        ...
        ("floating_window_tip", "SchoolWatch atzeko planoko zerbitzua mantentzen laguntzen du"),
        ...
        ("upgrade_remote_SchoolWatch_client_to_{}_tip", "Mesedez, eguneratu SchoolWatch bezeroa {} bertsiora edo berriagoa urruneko aldean!"),
