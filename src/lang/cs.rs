...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Připojování k SchoolWatch síti..."),
        ...
        ("install_tip", "Kvůli řízení oprávnění v systému (UAC), SchoolWatch v některých případech na protistraně nefunguje správně. Abyste se UAC vyhnuli, klikněte na níže uvedené tlačítko a nainstalujte tak SchoolWatch do systému."),
        ("Click to upgrade", "Aktualizovat"),
        ("Click to download", "Stáhnout"),
        ("Click to update", "Aktualizovat"),
        ("Configure", "Nastavit"),
        ("config_acc", "Aby bylo možné na dálku ovládat vaši plochu, je třeba aplikaci SchoolWatch udělit oprávnění pro \"Zpřístupnění pro hendikepované\"."),
        ("config_screen", "Aby bylo možné přistupovat k vaší ploše na dálku, je třeba aplikaci SchoolWatch udělit oprávnění pro \"Nahrávání obsahu obrazovky\"."),
        ...
        ("android_input_permission_tip1", "Aby vzdálené zařízení mohlo ovládat vaše Android zařízení prostřednictví myši či dotyků, je třeba povolit, aby SchoolWatch mohlo používat službu „Zpřístupnění hendikepovaným“."),
        ("android_input_permission_tip2", "Přejděte na následující stránku nastavení systému, najděte a přejděte do [Nainstalované služby] a zapněte službu [SchoolWatch vstup]."),
        ...
        ("Turned off", "Vypnutý"),
        ("Language", "Jazyk"),
        ("Keep SchoolWatch background service", "Zachovat službu SchoolWatch na pozadí"),
        ("Ignore Battery Optimizations", "Ignorovat optimalizaci baterie"),
        ("android_open_battery_optimizations_tip", "Pokud chcete tuto funkci zakázat, přejděte na další stránku nastavení aplikace SchoolWatch, najděte a zadejte [Baterie], zrušte zaškrtnutí [Neomezeno]."),
        ...
        ("Show SchoolWatch", "Zobrazit SchoolWatch"),
        ...
        ("config_input", "Chcete-li ovládat vzdálenou plochu pomocí klávesnice, musíte udělit oprávnění SchoolWatch \"Sledování vstupu\"."),
        ("config_microphone", "Abyste mohli mluvit na dálku, musíte udělit oprávnění SchoolWatch \"Nahrávat zvuk\"."),
        ...
        ("still_click_uac_tip", "Stále vyžaduje, aby vzdálený uživatel kliknul na OK v okně UAC spuštěného SchoolWatchu."),
        ...
        ("verify_SchoolWatch_password_tip", "Ověření hesla SchoolWatch"),
        ...
        ("scam_text1", "Pokud telefonujete s někým, koho NEZNÁTE a komu NEDŮVĚŘUJETE a kdo vás požádal o použití služby SchoolWatch a její spuštění, nepokračujte v hovoru a okamžitě zavěste."),
        ...
        ("upgrade_SchoolWatch_server_pro_to_{}_tip", "Aktualizujte prosím SchoolWatch Server Pro na verzi {} nebo novější!"),
        ...
        ("selinux_tip", "Na vašem zařízení je povolen SELinux, což může bránit správnému běhu SchoolWatchu jako řízené strany."),
        ...
        ("powered_by_me", "Poháněno společností SchoolWatch"),
        ...
        ("allow-only-conn-window-open-tip", "Povolit připojení pouze v případě, že je otevřené okno SchoolWatch"),
        ...
        ("floating_window_tip", "Pomáhá udržovat službu SchoolWatch na pozadí"),
        ...
        ("About SchoolWatch", "O SchoolWatch"),
        ...
        ("upgrade_remote_SchoolWatch_client_to_{}_tip", "Upgradujte prosím klienta SchoolWatch na verzi {} nebo novější na vzdálené straně!"),
