...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Vzpostavljanje povezave z omrežjem SchoolWatch..."),
        ...
        ("install_tip", "Zaradi nadzora uporabniškega računa, SchoolWatch v nekaterih primerih na oddaljeni strani ne deluje pravilno. Temu se lahko izognete z namestitvijo."),
        ("Click to upgrade", "Klikni za nadgradnjo"),
        ("Click to download", "Klikni za prenos"),
        ("Click to update", "Klikni za posodobitev"),
        ("Configure", "Nastavi"),
        ("config_acc", "Za oddaljeni nadzor namizja morate SchoolWatchu dodeliti pravico za dostopnost"),
        ("config_screen", "Za oddaljeni dostop do namizja morate SchoolWatchu dodeliti pravico snemanje zaslona"),
        ...
        ("android_input_permission_tip1", "Za oddaljeni nadzor vaše naprave Android, je potrebno SchoolWatchu dodeliti pravico za dostopnost."),
        ("android_input_permission_tip2", "Pojdite v sistemske nastavitve, poiščite »Nameščene storitve« in vklopite storitev »SchoolWatch Input«."),
        ...
        ("Language", "Jezik"),
        ("Keep SchoolWatch background service", "Ohrani SchoolWatchovo storitev v ozadju"),
        ("Ignore Battery Optimizations", "Prezri optimizacije baterije"),
        ("android_open_battery_optimizations_tip", "Če želite izklopiti to možnost, pojdite v nastavitve aplikacije SchoolWatch, poiščite »Baterija« in izklopite »Neomejeno«"),
        ...
        ("config_input", "SchoolWatch potrebuje pravico »Nadzor vnosa« za nadzor oddaljenega namizja s tipkovnico."),
        ("config_microphone", "SchoolWatch potrebuje pravico »Snemanje zvoka« za zajemanje zvoka."),
        ...
        ("verify_SchoolWatch_password_tip", "Preveri geslo za SchoolWatch"),
        ...
        ("scam_text1", "V primeru, da vas je nekdo, ki ga ne poznate in mu zaupate prosil, da uporabite SchoolWatch, prekinite klic in program zaprite."),
        ("scam_text2", "SchoolWatch omogoča popoln nadzor nad vašim računalnikom in telefonom, in se lahko uporabi za krajo vašega denarja ali pa zasebnih podatkov."),
        ...
        ("upgrade_SchoolWatch_server_pro_to_{}_tip", "Prosimo, nadgradite SchoolWatch Server Pro na različico {} ali novejšo."),
        ...
        ("powered_by_me", "Uporablja tehnologijo SchoolWatch"),
        ...
        ("allow-only-conn-window-open-tip", "Dovoli povezavo samo če je okno SchoolWatcha odprto"),
        ...
        ("floating_window_tip", "Pomaga pri SchoolWatch storitvi v ozadju"),
        ...
        ("About SchoolWatch", "O SchoolWatchu"),
        ...
        ("upgrade_remote_SchoolWatch_client_to_{}_tip", "Prosimo, nadgradite SchoolWatch odjemalec na različico {} ali novejšo na oddaljeni strani."),
