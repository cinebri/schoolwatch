...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("install_tip", "Kullanıcı Hesabı Denetimi nedeniyle, SchoolWatch bir uzak masaüstü olarak düzgün çalışmayabilir. Bu sorunu önlemek için, SchoolWatch'i sistem seviyesinde kurmak için aşağıdaki butona tıklayın."),
        ...
        ("Configure", "Ayarla"),
        ("config_acc", "Masaüstünüzü dışarıdan kontrol etmek için SchoolWatch'e \"Erişilebilirlik\""),
        ("config_screen", "Masaüstünüzü dışarıdan kontrol etmek için SchoolWatch'e \"Ekran Kaydı\" iznini vermeniz gerekir."),
        ...
        ("android_input_permission_tip1", "Uzak bir cihazın Android cihazınızı fare veya dokunma yoluyla kontrol edebilmesi için, SchoolWatch'in \"Erişilebilirlik\" özelliğini kullanmasına izin vermelisiniz."),
        ("android_input_permission_tip2", "Sonraki sistem ayarları sayfasına gidin, [Yüklü Hizmetler]'i bulun ve erişin, [SchoolWatch Girişi] hizmetini etkinleştirin."),
        ...
        ("Language", "Dil"),
        ("Keep SchoolWatch background service", "SchoolWatch arka plan hizmetini sürdürün"),
        ...
        ("Show SchoolWatch", "SchoolWatch'i Göster"),
        ("This PC", "Bu PC"),
        ("or", "veya"),
        ...
        ("config_input", "Uzaktaki masaüstünü klavye ile kontrol etmek için SchoolWatch'e \"Giriş İzleme\" izinleri vermelisiniz."),
        ("config_microphone", "Uzaktan konuşmak için SchoolWatch'e \"Ses Kaydı\" izinleri vermelisiniz."),
        ...
        ("still_click_uac_tip", "Uzaktaki kullanıcının çalışan SchoolWatch'in UAC penceresinde hala Tamam'ı tıklaması gerekmektedir."),
        ...
        ("verify_SchoolWatch_password_tip", "SchoolWatch parolasını doğrulayın"),
