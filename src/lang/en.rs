...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Connecting to the SchoolWatch network..."),
        ...
        ("install_tip", "Due to UAC, SchoolWatch can not work properly as the remote side in some cases. To avoid UAC, please click the button below to install SchoolWatch to the system."),
        ("config_acc", "In order to control your Desktop remotely, you need to grant SchoolWatch \"Accessibility\" permissions."),
        ("config_screen", "In order to access your Desktop remotely, you need to grant SchoolWatch \"Screen Recording\" permissions."),
        ...
        ("android_input_permission_tip1", "In order for a remote device to control your Android device via mouse or touch, you need to allow SchoolWatch to use the \"Accessibility\" service."),
        ("android_input_permission_tip2", "Please go to the next system settings page, find and enter [Installed Services], turn on [SchoolWatch Input] service."),
        ...
        ("doc_mac_permission", "https://SchoolWatch.com/docs/en/client/mac/#enable-permissions"),
        ("Ignore Battery Optimizations", "Ignore battery optimizations"),
        ("android_open_battery_optimizations_tip", "If you want to disable this feature, please go to the next SchoolWatch application settings page, find and enter [Battery], Uncheck [Unrestricted]"),
        ...
        ("config_input", "In order to control remote desktop with keyboard, you need to grant SchoolWatch \"Input Monitoring\" permissions."),
        ("config_microphone", "In order to speak remotely, you need to grant SchoolWatch \"Record Audio\" permissions."),
        ...
        ("still_click_uac_tip", "Still requires the remote user to click OK on the UAC window of running SchoolWatch."),
        ...
        ("verify_SchoolWatch_password_tip", "Verify SchoolWatch password"),
        ...
        ("scam_text1", "If you are on the phone with someone you DON'T know AND TRUST who has asked you to use SchoolWatch and start the service, do not proceed and hang up immediately."),
        ...
        ("upgrade_SchoolWatch_server_pro_to_{}_tip", "Please upgrade SchoolWatch Server Pro to version {} or newer!"),
        ("pull_group_failed_tip", "Failed to refresh group"),
        ("doc_fix_wayland", "https://SchoolWatch.com/docs/en/client/linux/#x11-required"),
        ("display_is_plugged_out_msg", "The display is plugged out, switch to the first display."),
        ("selinux_tip", "SELinux is enabled on your device, which may prevent SchoolWatch from running properly as controlled side."),
        ...
        ("powered_by_me", "Powered by SchoolWatch"),
        ...
        ("allow-only-conn-window-open-tip", "Only allow connection if SchoolWatch window is open"),
        ...
        ("floating_window_tip", "It helps to keep SchoolWatch background service"),
        ...
        ("upgrade_remote_SchoolWatch_client_to_{}_tip", "Please upgrade the SchoolWatch client to version {} or newer on the remote side!"),
