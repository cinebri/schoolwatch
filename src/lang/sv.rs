...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Ansluter till SchoolWatch..."),
        ...
        ("install_tip", "På grund av UAC, kan inte SchoolWatch fungera ordentligt på klientsidan. För att undvika problem med UAC, tryck på knappen nedan för att installera SchoolWatch på systemet."),
        ...
        ("config_acc", "För att kontrollera din dator på distans måste du ge SchoolWatch \"Tillgänglighets\" rättigheter."),
        ("config_screen", "För att kontrollera din dator på distans måste du ge SchoolWatch \"Skärminspelnings\" rättigheter."),
        ...
        ("android_input_permission_tip2", "Gå till systeminställningarna, hitta [Installed Services], sätt på [SchoolWatch Input] tjänsten."),
        ...
        ("Turned off", "Avstängd"),
        ("Language", "Språk"),
        ("Keep SchoolWatch background service", "Behåll SchoolWatch i bakgrunden"),
        ("Ignore Battery Optimizations", "Ignorera batterioptimering"),
        ("android_open_battery_optimizations_tip", "Om du vill stänga av denna funktion, gå till nästa SchoolWatch programs inställningar, hitta [Batteri], Checka ur [Obegränsad]"),
        ("Start on boot", ""),
        ...
        ("Show SchoolWatch", "Visa SchoolWatch"),
        ("This PC", "Denna dator"),
        ("or", "eller"),
