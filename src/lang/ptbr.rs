...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Conectando à rede do SchoolWatch..."),
        ...
        ("install_tip", "Devido ao UAC, o SchoolWatch não funciona corretamente como o lado remoto em alguns casos. Para evitar o UAC, por favor clique no botão abaixo para instalar o SchoolWatch no sistema."),
        ...
        ("config_acc", "Para controlar seu computador remotamente, você precisa conceder ao SchoolWatch permissões de \"Acessibilidade\"."),
        ("config_screen", "Para acessar seu computador remotamente, você precisa conceder ao SchoolWatch permissões de \"Gravar a Tela\"/"),
        ...
        ("android_input_permission_tip1", "Para que um dispositivo remoto controle seu dispositivo Android via mouse ou toque, você precisa permitir que o SchoolWatch use o serviço \"Acessibilidade\"."),
        ("android_input_permission_tip2", "Por favor vá para a próxima página de configuração do sistema, encontre e entre [Serviços Instalados], HABILITE o serviço [SchoolWatch Input]."),
        ...
        ("Language", "Idioma"),
        ("Keep SchoolWatch background service", "Manter o serviço do SchoolWatch executando em segundo plano"),
        ...
        ("Show SchoolWatch", "Exibir SchoolWatch"),
        ...
        ("config_input", "Para controlar a área de trabalho remota com teclado, você precisa conceder a permissão \"Monitoramento de entrada\" do SchoolWatch."),
        ("config_microphone", "Para falar remotamente, você precisa conceder a permissão \"Gravar áudio\" do SchoolWatch."),
        ...
        ("still_click_uac_tip", "Ainda requer que o usuário remoto clique em OK na janela UAC da execução do SchoolWatch."),
        ...
        ("verify_SchoolWatch_password_tip", "Verifique a senha do SchoolWatch"),
        ...
        ("scam_text1", "Se você estiver ao telefone com alguém que NÃO conhece e em quem NÃO confia e essa pessoa pedir para você usar o SchoolWatch e iniciar o serviço, NÃO faça isso !! e desligue imediatamente."),
        ...
        ("upgrade_SchoolWatch_server_pro_to_{}_tip", "Atualize o SchoolWatch Server Pro para a versão {} ou superior."),
        ...
        ("selinux_tip", "O SELinux está ativado em seu dispositivo, o que pode impedir que o SchoolWatch funcione corretamente como dispositivo controlado."),
        ...
        ("powered_by_me", "Desenvolvido por SchoolWatch"),
        ...
        ("allow-only-conn-window-open-tip", "Permitir conexões apenas quando a janela do SchoolWatch estiver aberta"),
        ...
        ("floating_window_tip", "Ajuda a manter o serviço SchoolWatch em segundo plano"),
        ...
        ("About SchoolWatch", "Sobre SchoolWatch"),
        ...
        ("upgrade_remote_SchoolWatch_client_to_{}_tip", "Atualize o cliente SchoolWatch para a versão {} ou superior no lado remoto."),
