...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Prisijungiama prie SchoolWatch tinklo..."),
        ...
        ("install_tip", "Kai kuriais atvejais UAC gali priversti SchoolWatch netinkamai veikti nuotoliniame pagrindiniame kompiuteryje. Norėdami apeiti UAC, spustelėkite toliau esantį mygtuką, kad įdiegtumėte SchoolWatch į savo kompiuterį."),
        ...
        ("config_acc", "Norėdami nuotoliniu būdu valdyti darbalaukį, turite suteikti SchoolWatch \"prieigos\" leidimus"),
        ("config_screen", "Norėdami nuotoliniu būdu pasiekti darbalaukį, turite suteikti SchoolWatch leidimus \"ekrano kopija\""),
        ("Installing ...", "Diegiama ..."),
        ("Install", "Diegti"),
        ...
        ("install_daemon_tip", "Norėdami, kad SchoolWatch startuotų automatiškai, turite ją įdiegti"),
        ...
        ("android_input_permission_tip1", "Kad nuotolinis įrenginys galėtų valdyti Android įrenginį pele arba liesti, turite leisti SchoolWatch naudoti \"Prieinamumo\" paslaugą."),
        ("android_input_permission_tip2", "Eikite į kitą sistemos nustatymų puslapį, suraskite \"Įdiegtos paslaugos\" ir įgalinkite \"SchoolWatch įvestis\" paslaugą."),
        ...
        ("Turned off", "Išjungti"),
        ("Language", "Kalba"),
        ("Keep SchoolWatch background service", "Palikti SchoolWatch fonine paslauga"),
        ...
        ("Show SchoolWatch", "Rodyti SchoolWatch"),
        ...
        ("config_input", "Norėdami valdyti nuotolinį darbalaukį naudodami klaviatūrą, turite suteikti SchoolWatch leidimus \"Įvesties monitoringas\"."),
        ("config_microphone", "Norėdami kalbėtis su nuotoline puse, turite suteikti SchoolWatch leidimą \"Įrašyti garsą\"."),
        ...
        ("still_click_uac_tip", "Vis tiek reikia, kad nuotolinis vartotojas paleidžiant SchoolWatch UAC lange paspaustų \"OK\"."),
        ...
        ("verify_SchoolWatch_password_tip", "Įveskite kliento SchoolWatch slaptažodį"),
        ...
        ("upgrade_remote_SchoolWatch_client_to_{}_tip", "Prašome atnaujinti nuotolinės pusės SchoolWatch klientą į {} ar naujesnę versiją!"),
