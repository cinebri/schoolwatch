...
#[inline]
pub fn is_schoolwatch() -> bool {
    hbb_common::config::APP_NAME.read().unwrap().eq("SchoolWatch")
}
...
fn get_api_server_(api: String, custom: String) -> String {
    ...
    "https://admin.schoolwatch.com".to_owned()
}

pub fn get_audit_server(api: String, custom: String, typ: String) -> String {
    let url = get_api_server(api, custom);
    if url.is_empty() || url.contains("schoolwatch.com") {
        return "".to_owned();
    }
...
pub fn check_process(arg: &str, mut same_uid: bool) -> bool {
    ...
    for (_, p) in sys.processes().iter() {
        ...
        // on mac, p.cmd() get "/Applications/SchoolWatch.app/Contents/MacOS/SchoolWatch", "XPC_SERVICE_NAME=com.carriez.SchoolWatch_server"
...
pub type SchoolWatchInterval = ThrottledInterval;

#[inline]
pub fn schoolwatch_interval(i: Interval) -> ThrottledInterval {
...
mod tests {
    ...
    #[tokio::test]
    async fn test_SchoolWatch_interval() {
        ...
        for maker in base_intervals.into_iter() {
            ...
            let mut timer = schoolwatch_interval(maker());
    ...
    #[allow(non_snake_case)]
    #[tokio::test]
    async fn test_SchoolWatch_interval_sleep() {
        let base_intervals = [interval_maker, interval_at_maker];
