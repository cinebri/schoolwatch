...
///
/// Note:
/// On linux, we use dbus to communicate multiple schoolwatch process.
...
const DBUS_NAME: &str = "org.schoolwatch.schoolwatch";
...
impl fmt::Display for DbusError {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        write!(f, "SchoolWatch DBus Error: {}", self.0)
    }
}
...
/// `dbus-send --session --print-reply --dest=org.schoolwatch.schoolwatch /dbus org.schoolwatch.schoolwatch.NewConnection string:'PEER_ID'`
