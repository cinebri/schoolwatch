...
// stop_schoolwatch_servers() is just a temp solution here.
fn force_stop_server() {
    stop_schoolwatch_servers();
...
pub fn start_os_service() {
    ...
    while running.load(Ordering::SeqCst) {
        ...
        if keeps_headless || keeps_session {
            // for fixing https://github.com/schoolwatch/schoolwatch/issues/3129 to avoid too much dbus calling,
            sleep_millis(500);
        } else {
            sleep_millis(super::SERVICE_INTERVAL);
        }
...
mod desktop {
    ...
    pub struct Desktop {
        ...
        pub xauth: String,
        pub home: String,
        pub is_schoolwatch_subprocess: bool,
    ...
    impl Desktop {
        ...
        pub fn is_headless(&self) -> bool {
            self.sid.is_empty() || self.is_schoolwatch_subprocess
        }
        ...
        fn set_is_subprocess(&mut self) {
            self.is_schoolwatch_subprocess = false;
            let cmd = format!(
            ...
            if let Ok(res) = run_cmds(&cmd) {
                if res.trim() != "0" {
                    self.is_schoolwatch_subprocess = true;
                }
            }
        }
...
pub fn uninstall_service(show_new_window: bool, _: bool) -> bool {
    ...
    // systemctl kill schoolwatch --tray, execute cp first
...
pub fn check_autostart_config() -> ResultType<()> {
    ...
    // https://github.com/schoolwatch/schoolwatch/issues/4863
